const localesInit = {
	languages: [{ name: 'English', code: 'en' }, { name: 'German', code: 'de' }, { name: 'Russian', code: 'ru' }],
	translation: {
		maps: {
			markerPosition: ['You are here.', 'Du bist hier.', 'Вы здесь.'],
			markerNearPosition: ['You are here... Maybe...', 'Du bist hier... Vielleicht...', 'Вы здесь... Возможно...'],
		},
		login: {
