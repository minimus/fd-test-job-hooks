...
import {
	HOME_SIGN_OUT,
	HOME_SIGN_IN,
	HOME_PASSWORD_RECOVERY_SENT,
	HOME_PASSWORD_RECOVERY_NEEDED,
	HOME_REMEMBER_ME_CHANGED,
	HOME_PASSWORD_CHANGED,
	HOME_USERNAME_CHANGED,
} from '../../actions'
...
export default function reducer(state: THomeState = initialState, action: TAction): THomeState {
	switch (action.type) {
